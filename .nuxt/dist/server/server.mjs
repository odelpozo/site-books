import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, unref, version, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, nextTick, onScopeDispose, watch, toRefs, computed, defineComponent, provide, Suspense, Fragment, Transition, useSSRContext, defineAsyncComponent, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "book",
    path: "/book",
    component: () => import("./_nuxt/book-601fNIk8.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DDFNnuC6.js")
  },
  {
    name: "library",
    path: "/library",
    component: () => import("./_nuxt/library-CDO_L6uI.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-6aNeQOtn.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Bd6-Tn9N.js"));
